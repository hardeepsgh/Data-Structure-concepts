package hardeepsingh_comp254lab1_ex3;
...
public class CircularlyLinkedList<E>   implements Cloneable{
  ...
  public CircularlyLinkedList<E> clone( ) throws CloneNotSupportedException{
		 CircularlyLinkedList<E> newList = (CircularlyLinkedList<E>) super.clone();
		 newList.tail = new Node<>(this.tail.getElement(), null);
		  Node<E> walk = this.tail.getNext();
		  Node<E> copy = newList.tail;
		  while(walk != tail) {
			  Node<E> newest = new Node<E>(walk.getElement(), copy.getNext());
			  copy.setNext(newest);
			  copy = newest;
			  copy.next = newList.tail;
			  walk = walk.getNext();
...
//main method
  public static void main  (String[] args) throws CloneNotSupportedException
  {
	  ...
	  CircularlyLinkedList<String> circularListClone = new CircularlyLinkedList<String>();
	 ...
	 // System.out.println(circularList);
	  try {
		  ...
		  circularListClone  =  (CircularlyLinkedList<String>) circularList.clone();
		  
		  System.out.println("here \n");
		  
		
		 
		  System.out.println(circularListClone);
		  circularListClone.addLast("E");
